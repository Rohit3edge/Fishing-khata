...
import { FaRecycle, FaRupeeSign, FaShoppingCart, FaAngleDown, FaBoxes, FaBuromobelexperte } from "react-icons/fa";
import { RiHomeGearFill, RiMentalHealthFill, RiBarChart2Fill } from "react-icons/ri";
          ...
          <div className="row navbar">
            <nav className="sidebar" id="side">
              <ul className="nav-lists pt-1">
                ...
                <li className="nav_items">
                  <p className="menu-title" onClick={() => { setShow(show === "Sale" ? "" : "Sale")}}>
                ...
                <li className="nav_items">
                  <p className="menu-title" onClick={() => { setShow(show === "Purchase" ? "" : "Purchase");  }}>
