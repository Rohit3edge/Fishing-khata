                ...
                <table className="table item-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="align-middle">
                        <button className="btn-sm btn-success" onClick={handleAddItem}>Add</button>
                      </td>
                    </tr>
    ...
    {state?.itemList?.map((option, idx) => (
      <option key={idx} value={option.id}>
        {option?.name}
                        ...
                        <td className="align-middle">
                          <button className="btn-sm btn-danger" onClick={() => handleRemoveItem(index)}>Remove</button>
                        </td>
                      </tr>
                    ))}

                    <tr>
                      <td colSpan="4" className="text-right align-middle"><strong>Shipping Cost:</strong></td>
                    ...
                    <tr>
                      <td colSpan="4" className="text-right align-middle"><strong>Grand Total:</strong></td>
                      <td colSpan="2" className="align-middle">
