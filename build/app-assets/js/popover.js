...
'use strict';
	...
	$('[data-popup=popover-color]').popover({
		template: '<div className="popover"><div className="bg-teal"><div className="popover-arrow"></div><div className="popover-inner"></div></div></div>'
	});
	...
	$('[data-popup=popover-border]').popover({
		template: '<div className="popover"><div className="border-orange"><div className="popover-arrow"></div><div className="popover-inner"></div></div></div>'
	});
